...
class _ImageToPdfState extends State<ImageToPdf> {
  ...
  final picker = ImagePicker();
  bool _loading = false;
  bool _multipleImages = false; // Add this line
                          ...
                          child: Column(
                            children: _images.map((image) => Container(
                              margin: EdgeInsets.only(bottom: 60),
                                  ...
                                  padding: EdgeInsets.all(10),
                                  child: Image.file(image).animate().scale(duration: 1000.ms),
                                )).toList(),
                          ),
                        ),
              SizedBox(height: 30),
                ...
                children:[
                  Checkbox(
                    ...
                    onChanged: (bool? value) {
                      setState(() {
                        _multipleImages = value!;
                      });
                    },
                  ),
                  Text(_multipleImages ? "Multiple Images" : "Single Image")
                ],
              ),
              SizedBox(height: 20),
              ElevatedButton.icon(
                ...
                icon: Icon(Icons.image),
                label: Text(_isselect ? "Want to convert Another" : "Select Image(s)", style: TextStyle(color: _isselect ? Colors.white : Colors.black)),
                style: ElevatedButton.styleFrom(
                  backgroundColor: _isselect ? Colors.black : Colors.white,
                  textStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                  shape: RoundedRectangleBorder(
